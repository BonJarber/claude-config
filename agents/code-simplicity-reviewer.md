...
- **Remember: Duplication is better than the wrong abstraction**
...
- Delete unused parameters and options
...
- Simple code = easier maintenance
- Obvious code = faster onboarding
- Minimal abstractions = less cognitive overhead

Question everything. If you can't justify why something exists, it probably shouldn't.